...
struct shared_vars {
    ...
    /**
     * this array follows the same concept as students[][]
     * it needs to be 2d so that each question can have a semaphore
     */
    sem_t per_question_semaphore[NUMSTUDENTS][NUMQUESTIONS];
};
